...
<style>
    ...
    .cx-report table.cve-table td.sast-cve-table-med,
                            ...
                            <ul class="chart">
                                ...
                                <li>
                                    <span class="bar-2" id="bar-med" style="height: ${sastMediumTotalHeight}px">
                                            ...
                                            <div id="med-new-scans" class="new-scans" style="height: ${sastMediumNewHeight}px"></div>
                                            <div id="med-recurrent-scans" class="recurrent-scans" style="height: ${sastMediumRecurrentHeight}px"></div>
                                    </span>
                                    <div class="bar-title-wrapper">
                                        <div class="bar-title-container">
                                            <div class="bar-title-icon">
                                    ...
                                    <li>
                                        ...
                                        <div class="bar-title-wrapper">
                                            <div class="bar-title-container">
                                                ...
                                                <div class="bar-title">High -</div>
                                                <div class="bar-count" id="osa-bar-count-high">${osa.results.totalHighVulnerabilities}</div>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="bar-title-wrapper">
                                            <div class="bar-title-container">
                                                ...
                                                <div class="bar-title">Medium -</div>
                                                <div class="bar-count" id="osa-bar-count-med">${osa.results.totalMediumVulnerabilities}</div>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <div class="bar-title-wrapper">
                                            <div class="bar-title-container">
                                                ...
                                                <div class="bar-title">Low -</div>
                                                <div class="bar-count" id="osa-bar-count-low">${osa.results.totalLowVulnerabilities}</div>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <div class="full-start-end">
                        ...
                        <div class="full-start">
                            ...
                            <div class="full-start-end-text-date">
                                ...
                                <div class="full-start-end-date" id="sast-full-start-date"></div>
                            </div>
                        </div>
                        ...
                        <div class="full-end">
                            ...
                            <div class="full-start-end-text-date">
                                ...
                                <div class="full-start-end-date" id="sast-full-end-date"></div>
                            </div>
                        </div>
                        ...
                        <div class="full-files">
                            ...
                            <div class="full-start-end-text-date">
                                ...
                                <div class="full-start-end-date" id="sast-full-files"></div>
                            </div>
                        </div>
                        ...
                        <div class="full-loc">
                            ...
                            <div class="full-start-end-text-date">
                                ...
                                <div class="full-start-end-date" id="sast-full-loc"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="full-start-end">
                        ...
                        <div class="full-start">
                            ...
                            <div class="full-start-end-text-date">
                                ...
                                <div class="full-start-end-date" id="osa-full-start-date"></div>
                            </div>
                        </div>
