 ...
 * Date: 15/09/2016.
 */
public abstract class CxClientHelper {

    public static final String HTML_TEMPLATE_LOCATION = "com/cx/client.html";
    private static final Logger log = LoggerFactory.getLogger(CxClientHelper.class);
    ...
    public static String compileHtmlReport(String csv, int highThreshold, int mediumThreshold, int lowThreshold) {
        ...
        String ret = null;
        ClassLoader classLoader = CxClientHelper.class.getClassLoader();
        try {
