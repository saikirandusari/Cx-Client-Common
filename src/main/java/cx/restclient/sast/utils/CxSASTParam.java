...
public class CxSASTParam {
    ...
    public static final String SAST_UPDATE_COMMENT = "/sast/scans/{scanId}/comment";

    public static final String SAST_SCAN_PROJECT = "/projects";//Create new project (default preset and configuration)
    public static final String SAST_GET_PROJECT = "/projects?name=$[{name}]&?team=$[{teamId}]";// Get  project)
    public static final String SAST_PROJECT_BY_ID = "/projects/{projectId}"; //GetProjectConfiguration
    public static final String SAST_ZIP_ATTACHMENT = "projects/{projectId}/sourceCode/attachment";//Attach ZIP file
